                        ...
                        <div className='h-[75vh] flex justify-center mt-[15vh] overflow-y-scroll'>
                            <div className='w-[70vw]'>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <textarea className='p-2 w-full h-[3rem] border border-[#3F3D56] rounded' name="title" id="title" />
                                    </div>
                                    <div className='text-[1.2rem] font-semibold my-2'>
                                    Description of the dormitory
                                    </div>
                                    <div>
                                    <textarea className=' p-2 w-full h-[7rem] border border-[#3F3D56] rounded'  name="description" id="description" />
                                    </div>
                                </div>
                            </div>
                        </div>
